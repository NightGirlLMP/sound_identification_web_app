...
function gotResults(error, results){
    if (error){
        ...
        document.getElementById("results_label").style.color = "rgb(" + randomnumber_r + "," + randomnumber_g
        + "," + randomnumber_b + ")";
        document.getElementById("results_confidence").style.color = "rgb(" +randomnumber_r + "," + randomnumber_g
        + "," + randomnumber_b + ")";
